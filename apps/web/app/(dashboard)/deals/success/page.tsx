                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
                        ...
                        <div className="bg-slate-900 dark:bg-white rounded-[35px] p-10 text-left text-white dark:text-slate-900 relative overflow-hidden h-full flex flex-col justify-between">
                            ...
                            <div className="pt-10 flex gap-4">
                                <Link href="/deals" className="flex-1 text-center py-4 bg-white/10 dark:bg-slate-50 rounded-2xl font-black text-sm hover:bg-white/20 dark:hover:bg-slate-100 transition-all">
                                    Manage Listings
                                </Link>
